...
<link rel="stylesheet" href="/vpan/Public/Home/css/withdraw.css">
...
<div class="wrap">
  <div class="index" style="min-height: 1114px;">
    ...
    <input value="<?php echo ($suer['utel']); ?>" id="utel" type="hidden">
    <input value="<?php echo ($suer['pwd']); ?>" id="pwd" type="hidden">
    <form id="withDraw" class="i-form" method="post" action="<?php echo U('User/cash');?>" onSubmit="return false;">
      	<ul class="form-box">
	        ...
	        <li class="f-line clearfix">
	          	...
	          	<input style="color: #000;" id="n-money" class="f-input" type="text" placeholder="请输入提取金额" name="bpprice">
	        </li>
			<li class="f-line clearfix">
	         	<label class="f-label">温馨提示</label>
				<em style="color:#D82C2C;font-size: 14px; padding-top: 2px; margin-left: -6px;">提现金额最低为100元,提现将在申请</em>
	         	<em style="color:#D82C2C; overflow: hidden;font-size: 14px; margin-top: -8px;">提交后1个工作日内（国家法定节假日顺延）处理.</em>
	        </li>
      	</ul>
      	<?php if(!empty($binfo)): if($binfo['bankname'] == ''): ?><ul class="form-box">
			        ...
			        <li class="f-line clearfix">
			          ...
			          <input style="color: #000;" id="cardNum" class="f-input c-1" type="text" name="banknumber" placeholder="请输入借记卡卡号" value="">
			        </li>
			        <li class="f-line clearfix">
			          <label class="f-label">姓名</label>
			          <input style="color: #000;" id="Name" class="f-input c-1" type="text" placeholder="请输入持卡人姓名" name="busername" value="">
			        </li>
		      	</ul>
      		<?php else: ?>
      	...
      	<?php else: ?>
	      	<ul class="form-box">
		        ...
		        <li class="f-line clearfix">
		          <label class="f-label">银行支行</label>
		          <input style="color: #000;" id="idNum" class="f-input c-1" type="text" name="branch" placeholder="请输入银行支行名称" value="">
		        </li>
		        <li class="f-line clearfix">
		          <label class="f-label">卡号</label>
		          <input style="color: #000;" id="cardNum" class="f-input c-1" type="text" name="banknumber" placeholder="请输入借记卡卡号" value="">
	    ...
	    <div class="f-p-line">
	        <input style="color: #000;" id="deal-pwd" name="pwd" class="f-pwd" type="password" maxlength="6" placeholder="请输入提现密码">
	    </div>
...
<script type="text/javascript">
    ...
    $(function () {
    	...
    	if ($('#utel').val()=='') {
        msg("请先完善联系电话");
        //window.setTimeout(function(){window.location.href="/index.php/Home/User/editle.html";},1000);
        window.setTimeout(function(){ location.href="<?php echo U('User/editle');?>";},1000);
       }
    	...
    	if($('#pwd').val()==''){
    		msg("请先完善提现密码");
    		window.setTimeout(function(){ location.href="<?php echo U('User/pwdadd');?>";},1000);
    	}
    ...
    var $wForm = $('#withDraw'),			//form表单
        ...
        //    				msg('该时间段不允许提现');
   					// }
						...
						//2秒后跳转代码
						window.setTimeout(function(){ location.href ="<?php echo U('User/memberinfo');?>"; },4000);
  					}
