...
<div class="ycdcdDiv">
    ...
    <li><a href="<?php echo U('User/help');?>"><span><img src="/vpan/Public/Home/images/phb.png"/></span><span>帮助</span></a></li>
...
<link rel="stylesheet" type="text/css" href="/vpan/Public/Home/css/phb.css" />
          ...
          <ul>
             <?php if(is_array($lists)): $k = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li>
                  <div class="con_ph">
                        ...
                        <div class="tx_div">
                          <?php if($vo["portrait"] == ''): ?><img src="/vpan/Public/Home/images/avatar.jpg"/>
                              <?php else: ?>
                             <img src="<?php echo ($vo["portrait"]); ?>"/><?php endif; ?>
                          
                        </div>
                        <div class="nickname_div"><?php echo ($vo["nickname"]); ?></div>
