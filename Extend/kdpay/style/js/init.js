...
function loadData(result,code) {
  
  ohlc = sort_data(result,code);
...
$(document).ready(function(){
   ...
   $(document).resize(updateChartSize);
    ...
    function sort_data(result,code){
      var data = result;
      var ohlc = [],
        volume = [],
      ...
      if(chart_type == 'candlestick'){
         // if (code=='yag15'||code=='zjbuzj') {
         //    for (var i = 0; i < dataLength; i++) {
         //      ohlc.push([
         //        data[i][0], // the date

         //        parseFloat( data[i][1]*2 ), // open
         //        parseFloat( data[i][2]*2 ), // high
         //        parseFloat( data[i][3]*2 ), // low
         //        parseFloat( data[i][4]*2 ) // close
         //      ]);
         //    }
         // }else{
            for (var i = 0; i < dataLength; i++) {
